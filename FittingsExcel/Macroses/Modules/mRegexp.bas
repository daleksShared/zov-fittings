...
Public Const patCaseFasadesIsDver As String = "((?:[/]\d+])|(?:äâ){1}|(?:ëåâ){1}|(?:ïðàâ){1}|(?:ââåðõ){1})"
...
Public Const patCaseFasadesNapravl As String = "(?:\d*[/]?\d*)?((?:\+?(?:òá|ìá|ìê|êâ|ðî|øà|âï|àð|ñó|C|D|in|ÂÊ|àí|M|N)[\sà-ÿÀ-ßa-zA-Z0-9-]*)(?: êëèåíò)?(?:\+?\d*(?:òá|ìá|ìê|êâ|ðî|øà|âï|àð|ñó|C|D|in|ÂÊ|àí|M|N)[\sà-ÿÀ-ßa-zA-Z0-9-]*)*)"
...
Public Const patCaseFasadesNapravlList As String = "(?:^\+())?(?:\d{3})?(?:[/]?)(\d*(?:òá|ìá|ìê|êâ|ðî|øà|âï|àð|ñó|C|D|in|ÂÊ|àí|M|N)[\sà-ÿÀ-ßa-zA-Z0-9-]*(?:[-](?:òá|ìá|ìê|êâ|ðî|øà|âï|àð|ñó|C|D|in|ÂÊ|àí|M|N)[\sà-ÿÀ-ßa-zA-Z0-9-+]*)?\d*)"
